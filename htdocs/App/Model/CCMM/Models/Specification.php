...
/**
 * Represents a specification with IRI and label
 */
class Specification implements XmlSerializable
{
...
/**
    ...
    {
        $element = $this->createElement($document, $elementName ?? 'specification');
