...
class PhotosRepository extends AbstractRepository
{
    ...
    {
        return $this->createQueryBuilder('p')->andWhere('p.herbarium = :userHerbarium  OR :isAdmin = true')->setParameter('userHerbarium', $user->getIdentity()->lastVisitedHerbarium)->setParameter('isAdmin', $user->isInRole('ROLE_ADMIN'));
    }
