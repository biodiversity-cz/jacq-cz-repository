...
class SpecimenMetadata
{
    ...
    #[Column(nullable: true)]
    public protected(set) ?string $taxon = null;

    #[Column(nullable: true)]
    public protected(set) ?string $country = null;

    #[Column(nullable: true)]
    public protected(set) ?float $lat = null;

    #[Column(nullable: true)]
    public protected(set) ?float $lon = null;

    #[Column(nullable: true)]
    public protected(set) ?string $collection = null;
    ...
    public protected(set) ?Photos $photo = null;
