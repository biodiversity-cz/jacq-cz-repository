...
class Herbaria extends \App\Model\Database\Entity\Herbaria implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".'*'."\0".'license' => [parent::class, 'license', null, 8],
        "\0".'*'."\0".'logo' => [parent::class, 'logo', null, 8],
        "\0".'*'."\0".'multipleBarcodeMultiplier' => [parent::class, 'multipleBarcodeMultiplier', null, 8],
        ...
        'license' => [parent::class, 'license', null, 8],
        'logo' => [parent::class, 'logo', null, 8],
        'multipleBarcodeMultiplier' => [parent::class, 'multipleBarcodeMultiplier', null, 8],
