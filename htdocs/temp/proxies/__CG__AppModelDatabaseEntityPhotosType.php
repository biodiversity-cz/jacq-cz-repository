 ...
 */
class PhotosType extends \App\Model\Database\Entity\PhotosType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhotosType $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setColor(string $color): \App\Model\Database\Entity\PhotosType
    {
