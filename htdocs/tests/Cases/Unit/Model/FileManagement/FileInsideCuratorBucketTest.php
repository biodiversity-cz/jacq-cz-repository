...
test('FileInsideCuratorBucket::getUploaded formats timestamp correctly', function (): void {
    ...
    $file = new FileInsideCuratorBucket('image.tif', 10 * 1024 * 1024, 5, $timestamp, false, false, null, null);
...
test('FileInsideCuratorBucket::isSizeOk returns false when too large', function (): void {
    ...
    $file = new FileInsideCuratorBucket('image.tif', FileInsideCuratorBucket::MAX_FILESIZE + 1, 5, $timestamp, false, false, null, null);
...
test('FileInsideCuratorBucket::isTypeOk returns true for correct extension', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('photo.tif', 10 * 1024 * 1024, 5, $timestamp, false, false, null, null);
...
test('FileInsideCuratorBucket::isTypeOk returns false for wrong extension', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('document.jpg', 10 * 1024 * 1024, 5, $timestamp, false, false, null, null);
...
test('FileInsideCuratorBucket::isAlreadyWaiting reflects constructor value', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('image.tif', 10 * 1024 * 1024, 5, $timestamp, true, false, null, null);
...
test('FileInsideCuratorBucket::hasControlError reflects constructor value', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('image.tif', 10 * 1024 * 1024, 5, $timestamp, false, true, null, null);
...
test('FileInsideCuratorBucket::getControlMsg returns message if set', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('image.tif', 10 * 1024 * 1024, 5, $timestamp, false, false, null, 'bad checksum');
...
test('FileInsideCuratorBucket::isEligibleToBeImported false when has control error', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('image.tif', 10 * 1024 * 1024, 5, $timestamp, false, true, null, 'error');
...
test('FileInsideCuratorBucket::hasPrecontrolError true if size invalid', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('image.tif', 1, 5, $timestamp, false, false, null, null);
...
test('FileInsideCuratorBucket::hasPrecontrolError true if type invalid', function (): void {
    $timestamp = new DateTimeResult('now');
    $file = new FileInsideCuratorBucket('image.jpg', 10 * 1024 * 1024, 5, $timestamp, false, false, null, null);
